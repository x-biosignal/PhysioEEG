...
- [`eegAutoReject()`](https://x-biosignal.github.io/PhysioEEG/reference/eegAutoReject.md)
...
- [`eegKcomplexDetect()`](https://x-biosignal.github.io/PhysioEEG/reference/eegKcomplexDetect.md)
  : Detect K-Complexes
- [`eegLateralization()`](https://x-biosignal.github.io/PhysioEEG/reference/eegLateralization.md)
